...
export default function ContactPage() {
  return <><Header/><main className="subpage"><div className="subpage-wrap">
    ...
    <div className="contact-grid">
      <section className="contact-card"><h2>Store details</h2><p><b>Address</b><br/>{store.address}</p><p><b>Phone</b><br/><a href={`tel:${store.phone}`}>{store.phone}</a></p><p><b>Email</b><br/><a href={`mailto:${store.email}`}>{store.email}</a></p><div className="placeholder-note">The address and phone are launch placeholders. Update them in Admin → Store before publishing publicly.</div></section>
